package com.moonfish.testeleccionesgenerales2015.charts;
 ...
 */
public class HorizontalBarMoonfish extends BarChart {

    public HorizontalBarMoonfish(Context context) {
        super(context);
    }

    public HorizontalBarMoonfish(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalBarMoonfish(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new HorizontalBarRenderer(this, mAnimator, mViewPortHandler);
